  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless project management with Fillipe Augusto. Streamline your workflow, increase productivity, and achieve your project goals efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1611224923853-80b023f02d71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwcm9qZWN0JTJCbWFuYWdlbWVudHxlbnwwfHx8fDE2OTgxOTg2Njl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless project management with Fillipe Augusto. Streamline your workflow, increase productivity, and achieve your project goals efficiently.`}
            </Text>
            <Box
